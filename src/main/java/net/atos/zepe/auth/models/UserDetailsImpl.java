...
public class UserDetailsImpl implements UserDetails {
	...
	public static UserDetailsImpl build(UserEntity user) {
		...
		return new UserDetailsImpl(user.getId(), user.getUsername(), user.getUserEmailAddress(), user.getUserPassword(),
				user.getUserStatus(), user.isFirstConnection(), authorities);
	}
